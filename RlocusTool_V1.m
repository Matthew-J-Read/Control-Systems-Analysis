...
gain1 = (0:0.01:1);             % 0.001 Gain increments to 1
gain2 = (1:0.1:10);             % 0.01 Gain increments to 10
...
c = 101;                                 % c variable for nested loop
...
c = 91;                                  % change c variable for 2nd time around
end
